      ...
      <v-row class="spacing4">
        ...
        <v-col class="pa-6" md="6" cols="12">
          ...
          <v-row v-if="isDesktop" justify="space-around">
            <v-col v-for="(footer, index) in footers" :key="index" sm="3" cols="12" class="px-lg-4 px-0 site-map-item">
              <h6 class="title-nav">
                {{ footer.title }}
              </h6>
              <ul>
        ...
        <v-col md="3" cols="12" class="pa-4">
          <div class="socmed">
            <v-btn variant="text" icon class="button">
          ...
          <v-select v-model="lang" :items="langList" :value="curLang" variant="outlined" class="select-lang"
            color="primary" prepend-inner-icon="mdi-web" @update:model-value="switchLang(lang)" />
        </v-col>
      </v-row>
...
import logo from '@/assets/images/education-logo-2.png';
...
export default {
  ...
  data: () => ({
    ...
    footers: [
      {
        title: 'Entreprise',
        description: ['Equipe', 'Email', 'Contacte',],
      ...
      },
      {
        ...
        link: [
          'https://discord.gg/paE5qMSBhG',
          'mailto:coaching@letraderafricain.com',
          'tel:96004637',
          'https://www.bing.com/maps/traffic?setlang=fr-xl&FORM=Trafi2&cvid=0395596e5284492f941fe76b764d871b&ocid=winp2fp&cp=9.349988~2.619209&lvl=13.0&detectedloc=6.367365837097168~2.4518837928771973&detectedlocacc=362.72686767578125&ttid=9.86364555358887%2C2.71804594993591%2C9.34309864044189%2C2.62575006484985&ei=6',
        ],
      },
      {
        title: 'Mention Legal',
        description: ['Politique', 'Terme et condition'],
