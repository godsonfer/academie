  ...
  <v-menu v-model="open" :close-on-content-click="false" location="bottom" class="ma-0">
    ...
    <v-list class="popover ocean-var">
      <div class="mode-menu">
        ...
        <v-list-item>
          <div class="flex-menu">
            ...
            <v-switch :model-value="isDark" class="switch-toggle" hide-details color="secondary" @change="switchDark()" />
            <span>
      ...
      <!-- <div class="lang-menu">
        ...
        <v-list-item v-for="(lang, index) in langList" :key="index" :value="lang.code" :to="switchLocalePath(lang.code)"
          nuxt @click="switchRtl(lang.code)">
          <template #prepend>
            <v-avatar class="flag">
              <i :class="lang.code" />
            </v-avatar>
