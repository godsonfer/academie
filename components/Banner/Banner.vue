  ...
  <div class="hero-content">
    <v-container :class="{ 'fixed-width': isDesktop }">
      <v-row class="banner-wrap">
        <v-col class="px-6" cols="12" lg="6" md="7">
          <div class="banner-text">
            ...
            <v-card class="search-banner">
              <!-- <v-text-field :label="$t('educationLanding.banner_search')" class="search" color="primary" hide-details
                variant="filled" /> -->
              <!-- <div class="action">
        ...
        <v-col v-if="isTablet" lg="6" cols="12" class="md-5 pa-6 deco-grid">
          <div class="deco-banner">
            <div class="artwork-bg">
              <div class="oval" />
              <div v-if="loaded" class="parallax-scene back">
                <kinesis-container :duration="1500" easing="cubic-bezier(0.23, 1, 0.32, 1)">
                  <kinesis-element :strength="30" type="translate" tag="div">
                    <span class="icon-three" />
                  </kinesis-element>
                  <kinesis-element :strength="20" type="translate" tag="div">
