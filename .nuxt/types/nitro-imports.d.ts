declare global {
  ...
  const createSlug: typeof import('../../server/utils/createSlug')['default']
  ...
  const protectRoute: typeof import('../../server/utils/protectRoute')['default']
...
export { default as createSlug } from '../../server/utils/createSlug';
export { default as protectRoute } from '../../server/utils/protectRoute';